...
const socialLinks: SocialLink[] = [
  ...
  {
    href: 'https://instagram.com/bhaskar__1517',
  ...
  {
    href: 'https://discord.com/users/1273333726323019817',
  ...
  return (
    <div className="flex flex-col md:flex-row items-start md:items-center gap-8 p-8 border-b border-theme-card-border">
      <div className="relative group">
        <div className="absolute -inset-1.5 rounded-lg blur-lg opacity-50 group-hover:opacity-75 transition duration-1000">
          <img
            src="/avatar.png"
            alt=""
        ...
        <img
          src="/avatar.png"
          alt="Profile Picture"
          className="relative rounded-lg w-32 h-32 object-cover"
          width={128}
          height={128}
      ...
      <div className="flex flex-col gap-4">
        <div>
          <h1 className="font-black text-4xl bg-clip-text text-transparent bg-gradient-to-r from-theme-foreground via-theme-foreground to-theme-foreground-secondary dark:from-white dark:via-white dark:to-gray-400">
            Bhaskar
          </h1>
          <p className="font-medium text-theme-foreground-secondary dark:text-gray-300">
            She is Mine &lt;3
          </p>
            ...
            <div className="flex flex-wrap items-center gap-3 mt-3">
              {socialLinks.map((link) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-black/10 dark:via-white/20 to-transparent" />
                  <div className="relative w-5 h-5 flex items-center justify-center">
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="text-theme-foreground-secondary dark:text-white/80 group-hover:text-theme-foreground dark:group-hover:text-white transition-colors"
                      viewBox="0 0 16 16"
                    >
                      <path d={link.icon} />
                    </svg>
                  </div>
                  <span className="text-xs text-theme-foreground-secondary dark:text-white/80 group-hover:text-theme-foreground dark:group-hover:text-white transition-colors">
                    {link.label}
                  </span>
                </a>
              ))}
